...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { category_id: @type.category_id, name: @type.name, type_id: @type.type_id, visible: @type.visible } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { category_id: @type.category_id, name: @type.name, type_id: @type.type_id, visible: @type.visible } }
